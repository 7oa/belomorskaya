...
?>
	<!--fullsize-img-->
	<div class="fullsize-img"><img src="<?=SITE_TEMPLATE_PATH?>/images/hotel-bg.jpg">
		<div class="fullsize-img__content">
			<div class="fullsize-img__city">
				<?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"AREA_FILE_SHOW" => "file",
						"AREA_FILE_SUFFIX" => "include/index/ttl_city",
						"EDIT_TEMPLATE" => "",
						"PATH" => "include/index/ttl_city"
					)
				);?></div>
			<div class="fullsize-img__ttl">
				<?$APPLICATION->IncludeComponent(
					...
					Array(
						"AREA_FILE_RECURSIVE" => "Y",
						"AREA_FILE_SHOW" => "file",
						"AREA_FILE_SUFFIX" => "include/index/ttl_h1",
						"EDIT_TEMPLATE" => "",
						"PATH" => "include/index/ttl_h1"
					)
				);?></div>
			<div class="fullsize-img__desc">
				<?$APPLICATION->IncludeComponent(
					...
					Array(
						"AREA_FILE_RECURSIVE" => "Y",
						"AREA_FILE_SHOW" => "file",
						"AREA_FILE_SUFFIX" => "include/index/ttl_desc",
						"EDIT_TEMPLATE" => "",
						"PATH" => "include/index/ttl_desc"
					)
				);?></div>
		</div>
	</div>
